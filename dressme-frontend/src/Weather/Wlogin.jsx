            ...
            <div class="col-lg-7">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3">
                        ...
                        <input class="mb-4 text-white" type="text"  placeholder="Enter Username" value={username}
                        onChange={(e) => setUsername(e.target.value)}/>
                    </div>
                    <div class="row px-3">
                        <label class="mb-1"><h6 class="mb-0 text-sm"><b>Password</b></h6></label>
                        <input class="text-white" type="password" name="password" placeholder="Enter password" value={password}
